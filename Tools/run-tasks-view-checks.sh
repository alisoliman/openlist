...
xcrun swiftc -swift-version 6 -default-isolation MainActor -o "$OUT/tasks-view-checks" \
    ...
    openlist/Model/CalendarTypes.swift openlist/Model/ListCover.swift openlist/Model/TaskList.swift openlist/Model/ListHierarchy.swift openlist/Model/TaskLabel.swift \

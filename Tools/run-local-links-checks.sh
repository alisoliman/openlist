...
xcrun swiftc -swift-version 6 -default-isolation MainActor -o "$OUT/link-checks" \
    ...
    openlist/Model/LocalLink.swift openlist/Model/BlockSelection.swift Shared/ListAccent.swift openlist/Services/LibraryIdentity.swift openlist/Services/NoteItemLink.swift \

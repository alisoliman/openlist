...
xcrun swiftc -swift-version 6 -default-isolation MainActor -o "$OUT/fragment-checks" \
  openlist/Model/*.swift Tools/InboxChecks/LegacyInboxMembership.swift Shared/ListAccent.swift Tools/ReusableCopyChecks/ReviewSession.swift openlist/Next/NextEditorTypography.swift \

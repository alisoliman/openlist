...
xcrun swiftc -swift-version 6 -default-isolation MainActor -o "$OUT/widget-action-checks" \
  ...
  Tools/WidgetActionChecks/ReviewSession.swift openlist/Design/Theme.swift \
  ...
  openlist/Services/Navigator.swift openlist/Services/DragPayload.swift openlist/Views/TaskCaptureRequest.swift openlist/Services/NoteItemLink.swift \

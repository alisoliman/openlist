...
@main struct LegacyFixture {
    static func main() throws {
        ...
        list.coverFilename = "pre-nesting-cover.png"
        list.coverData = Data(repeating: 0x35, count: 1_048_631)
        list.coverMetadataData = try JSONEncoder().encode(ListCoverMetadata(displayName: "Original cover.png",
            contentType: "image/png", byteCount: 1_048_631, pixelWidth: 10, pixelHeight: 10))
        list.coverPresentationRaw = "hidden"
        context.insert(list)

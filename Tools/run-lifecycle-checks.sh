...
xcrun swiftc -swift-version 6 -default-isolation MainActor -o "$OUT/lifecycle-checks" \
  openlist/Model/*.swift Shared/ListAccent.swift Tools/LifecycleChecks/ReviewSession.swift openlist/Next/NextEditorTypography.swift \
  ...
  openlist/Services/Store+Sidebar.swift openlist/Services/BlockTree.swift openlist/Services/RichTextCodec.swift \

...
xcrun swiftc -swift-version 6 -default-isolation MainActor -o "$OUT/reminder-store-checks" \
  ...
  openlist/Services/ReminderNotificationClient.swift openlist/Services/ReminderRecovery.swift openlist/Services/ReminderNavigation.swift openlist/Services/Navigator.swift openlist/Services/DragPayload.swift \

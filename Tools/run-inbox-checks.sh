...
xcrun swiftc -swift-version 6 -default-isolation MainActor -o "$OUT/inbox-checks" \
  openlist/Model/*.swift Tools/InboxChecks/LegacyInboxMembership.swift Shared/ListAccent.swift Tools/InboxChecks/ReviewSession.swift Shared/WidgetSnapshot.swift Shared/WidgetKind.swift Shared/AppGroup.swift openlist/Design/Theme.swift \
  ...
  openlist/Services/BlockTree.swift openlist/Services/RichTextCodec.swift openlist/Services/ActiveTaskPolicy.swift openlist/Services/ListTasksProjection.swift openlist/Services/WidgetSnapshotPublisher.swift \

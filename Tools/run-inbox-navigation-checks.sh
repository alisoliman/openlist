...
xcrun swiftc -swift-version 6 -default-isolation MainActor -o "$OUT/inbox-navigation-checks" \
    openlist/Model/Block.swift openlist/Model/TrashMetadata.swift openlist/Model/InboxMembership.swift openlist/Model/BlockKind.swift \
    openlist/Model/Recurrence.swift openlist/Model/CalendarTypes.swift openlist/Model/ListCover.swift openlist/Model/TaskList.swift \

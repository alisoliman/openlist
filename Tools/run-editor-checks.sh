...
xcrun swiftc -swift-version 6 -default-isolation MainActor -o "$OUT/editor-checks" \
  ...
  openlist/Editor/OutlineEditor.swift openlist/Editor/SlashMenuView.swift openlist/Editor/SlashMenuDismissal.swift openlist/Editor/BlockDragAndDrop.swift openlist/Views/RowSelectionControl.swift \

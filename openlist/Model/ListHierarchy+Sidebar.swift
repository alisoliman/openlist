...
extension ListHierarchy {
    ...
    /// followed by its nested lists. The sidebar shows `active` in this order,
    /// and the widgets' list picker follows it. `sections` are in their own
    /// order.
